...
def create_string(s,p,pv,s_clean,w):
...
def export_fit(eq_str,params,paramvals,w, dir):
    ...
    export_str = create_string(eq_export,params,paramvals,eq_str,w)
